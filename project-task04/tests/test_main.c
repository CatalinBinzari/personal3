...
void is_first_char_slash_valid(void **state);
void is_first_char_slash_valid_2(void **state);
void tokenize_valid(void **state);
...
int main()
{
  const struct CMUnitTest tests[] = {
      ...
      cmocka_unit_test(is_first_char_slash_valid),
      cmocka_unit_test(is_first_char_slash_valid_2),
      cmocka_unit_test(tokenize_valid),
...
/*
  Name:        is_first_char_slash_valid

  Purpose:     Tests function is_first_char_slash for valid result
...
void is_first_char_slash_valid(void **state)
{
  char msg[] = "    /connect serv.com\r\n";
  bool is_slash = is_first_char_slash(msg);

  assert_true(is_slash);
} /* is_first_char_slash_valid */

/*
  Name:        is_first_char_slash_valid_2
...
void is_first_char_slash_valid_2(void **state)
{
  char msg[] = "    hello serv.com\r\n";
  bool is_slash = is_first_char_slash(msg);

  assert_false(is_slash);
} /* is_first_char_slash_valid_2 */

/*
  Name:        tokenize_valid

  Purpose:     Tests function tokenize for valid result
...
{
  char *token_array[15];
  char msg[] = "/CONNECT irc.undernet.org and some other strings\r\n";
  bool is_ok = tokenize(msg, token_array);

  assert_string_equal(token_array[0], "/CONNECT");
  assert_true(is_ok);
} /* tokenize_valid */