...
void greater_age_same_age(void **state);
/*****************************************************************************/
/*                                                                           */
/*****************************************************************************/
...
int main()
{
  const struct CMUnitTest tests[] = {
      ...
      cmocka_unit_test(greater_age_same_age),
  };
...
/*
  Name:        greater_age_same_age

  Purpose:     Test function greater_age for valid result with the same age
...
void greater_age_same_age(void **state)
{
  struct person p1={"name1", 8};
  struct person p2={"name2", 8};
  struct person p3;
  p3 = greater_age(p1, p2);

  assert_string_equal(p3.name, "The same age");
  assert_int_equal(p3.age, 8);

} /* greater_age_same_age */
